...
def parse_args_and_config():
    ...
    # T-sampling override logic added here
    parser.add_argument("--T_sampling", type=int, default=-1,
                        help="Override config sampling.T_sampling if >=0")
    parser.add_argument(
        "--mu", type=float, default=1, help="mu hyperparameter"
    )
    # NNP & DSR arguments added here
    parser.add_argument("--mu_factor", type=float, default=1.0)
    parser.add_argument("--use_nnp", type=int, default=0)
    parser.add_argument("--nnp_steps", type=str, default="")
    parser.add_argument("--use_dsr", type=int, default=0)
    parser.add_argument("--dsr_repeat", type=int, default=1)
    parser.add_argument("--dsr_repeat_damp", type=float, default=1.0)
    parser.add_argument("--dsr_repeat_noise_damp", type=float, default=1.0)
    ...
    # T-sampling override applied here
    if int(getattr(args, "T_sampling", -1)) >= 0:
        new_config.sampling.T_sampling = int(args.T_sampling)
